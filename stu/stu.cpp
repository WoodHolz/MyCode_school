...
int main()
{
    ...
    FILE* fp = NULL;
    fp = fopen("stu.txt", "a+"); //以读/写方式打开一个文本文件，允许读或在文本末追加数据；若文件不存在，则会建立该文件。

    menu();
    stu* aim = NULL, * re = NULL;
    re = read(fp);
    //printf("\n%d\n", choose()); test choose
    int num = 9;
    while (1) {
        ...
        switch (num) //选择功能
        {
        case 1: aim = creat(re); getchar();/* printf("\n%p", aim)*/; break;
